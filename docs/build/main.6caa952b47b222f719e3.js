...
var childrenPropType = _propTypes2.default.oneOfType([_propTypes2.default.arrayOf(_propTypes2.default.node), _propTypes2.default.node]);
...
var lowPriorityWarning = __webpack_require__(165);
...
var _childrenPropType = __webpack_require__(89);
...
var Group = (_temp2 = _class = function (_Component) {
  ...
  function Group() {
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = Group.__proto__ || (0, _getPrototypeOf2.default)(Group)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      results: [],
      activeIndex: 0
    }, _this.handleBenchmarkStop = function (props, results) {
      _this.setState({
        activeIndex: _this.state.activeIndex + 1,
        results: _this.state.results.concat([results])
      }, function () {
...
var _reactAddonsPerf = __webpack_require__(148);
...
var Test = (_temp2 = _class = function (_Component) {
  ...
  (0, _createClass3.default)(Test, [{
    ...
    key: 'render',
    value: function render() {
      return this.state.running ? _react2.default.createElement('div', { className: styles.content }, this.props.children) : null;
    }
  }]);
  return Test;
}(_react.Component), _class.propTypes = {
...
var ResultRow = (_temp = _class = function (_Component) {
  ...
  (0, _createClass3.default)(ResultRow, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement('tr', null, _react2.default.createElement('td', { style: { textAlign: 'right' } }, keySplit[0], ' > ', _react2.default.createElement('strong', null, keySplit[1])), _react2.default.createElement('td', null, result.inclusiveRenderDuration.toFixed(2)), _react2.default.createElement('td', null, result.instanceCount.toFixed(0)), _react2.default.createElement('td', null, (result.inclusiveRenderDuration / result.instanceCount).toFixed(2)));
    }
  }]);
  return ResultRow;
}(_react.Component), _class.propTypes = {
...
var TestResults = (_temp3 = _class2 = function (_Component2) {
  ...
  (0, _createClass3.default)(TestResults, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement('table', { className: 'ui table' }, _react2.default.createElement('thead', null, _react2.default.createElement('tr', null, _react2.default.createElement('th', null, 'Component'), _react2.default.createElement('th', null, 'Total Time'), _react2.default.createElement('th', null, 'Instances Rendered'), _react2.default.createElement('th', null, 'Time / Instance'))), _react2.default.createElement('tbody', null, results.map(renderResult)));
    }
  }]);
  return TestResults;
...
var _Group = __webpack_require__(181);

var _Group2 = _interopRequireDefault(_Group);

var _GroupResults = __webpack_require__(228);
...
var GroupPresenter = (_temp2 = _class = function (_Component) {
  ...
  (0, _createClass3.default)(GroupPresenter, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement('div', { className: 'ui segment' }, _react2.default.createElement('h2', { className: 'ui header', style: { display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '0' } }, _react2.default.createElement('span', null, title, ' ', _react2.default.createElement('span', { className: 'ui label mini' }, 'group')), _react2.default.createElement('button', { className: 'ui button secondary', onClick: this.toggle }, buttonText)), _react2.default.createElement(_Group2.default, { active: active, onBenchmarkStop: this.handleBenchmarkStop, onBenchmarkStart: this.handleBenchmarkStart }, children), this.renderResults());
    }
  }]);
...
var _TestResults = __webpack_require__(184);
...
var GroupPresenter = (_temp2 = _class = function (_Component) {
  ...
  (0, _createClass3.default)(GroupPresenter, [{
    ...
    value: function renderResults() {
      ...
      if (results !== initialState.results) {
        return _react2.default.createElement(_TestResults2.default, { results: results });
      }
    }
  }, {
    key: 'render',
    value: function render() {
      ...
      return _react2.default.createElement('div', { className: 'ui segment' }, _react2.default.createElement('h2', { className: 'ui header', style: { display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '0' } }, _react2.default.createElement('span', null, title, ' ', _react2.default.createElement('span', { className: 'ui label mini' }, 'standalone')), _react2.default.createElement('button', { className: 'ui button secondary', onClick: this.toggle }, buttonText)), _react2.default.createElement(_Test2.default, { active: active, onBenchmarkStop: this.handleBenchmarkStop, onBenchmarkStart: this.handleBenchmarkStart }, children), this.renderResults());
    }
  }]);
  return GroupPresenter;
}(_react.Component), _class.propTypes = {
...
var ResultRow = (_temp2 = _class = function (_Component) {
  ...
  (0, _createClass3.default)(ResultRow, [{
    ...
    value: function render() {
      var _props = this.props,
          rank = _props.rank,
          inclusive = _props.results.inclusive;
      var isInspecting = this.state.isInspecting;

      var color = rank === 0 ? 'positive' : 'warning';

      return _react2.default.createElement('tbody', null, _react2.default.createElement('tr', { className: color }, _react2.default.createElement('td', null, this.title), _react2.default.createElement('td', null, this.total.toFixed(2)), _react2.default.createElement('td', null, this.instanceCount.toFixed(0)), _react2.default.createElement('td', null, this.perComponentTime.toFixed(2)), _react2.default.createElement('td', null, _react2.default.createElement('button', { onClick: this.toggle, className: 'ui icon button tiny' }, _react2.default.createElement('i', { className: 'icon search' })))), isInspecting ? _react2.default.createElement('tr', null, _react2.default.createElement('td', { colSpan: 5 }, _react2.default.createElement(_TestResults2.default, { results: inclusive }))) : null);
    }
  }, {
    key: 'mainResult',
    get: function get() {
      return this.props.results.inclusive[1];
    }
  }, {
    key: 'title',
    get: function get() {
      return this.props.results.title || this.mainResult.key;
    }
  }, {
    key: 'total',
    get: function get() {
...
var GroupResults = (_temp4 = _class2 = function (_Component2) {
  ...
  function GroupResults() {
    ...
    return _ret2 = (_temp3 = (_this2 = (0, _possibleConstructorReturn3.default)(this, (_ref2 = GroupResults.__proto__ || (0, _getPrototypeOf2.default)(GroupResults)).call.apply(_ref2, [this].concat(args))), _this2), _this2.renderResult = function (result) {
      ...
      return _react2.default.createElement(ResultRow, { results: result, rank: rank });
  ...
  (0, _createClass3.default)(GroupResults, [{
    key: 'render',
    value: function render() {
      return _react2.default.createElement('table', { className: 'ui table' }, _react2.default.createElement('thead', null, _react2.default.createElement('tr', null, _react2.default.createElement('th', null, 'Component'), _react2.default.createElement('th', null, 'Total Time'), _react2.default.createElement('th', null, 'Instances Rendered'), _react2.default.createElement('th', null, 'Time / Instance'), _react2.default.createElement('th', { style: { width: '40px' } }))), this.props.results.map(this.renderResult));
    }
  }, {
    key: 'ordered',
    get: function get() {
...
var _TestPresenter = __webpack_require__(222);
...
var _GroupPresenter = __webpack_require__(221);
...
/***/ })
/******/ ]);
//# sourceMappingURL=main.6caa952b47b222f719e3.js.map